...
mod tests {
    ...
    mod decode_u64_test {
        ...
        fn helper(input: &str, expect: Result<u64, &str>, expected_len: usize) {
            let mut len: usize = 0;
    ...
    mod decode_i64_test {
        ...
        fn helper(input: &str, expect: Result<i64, &str>, expected_len: usize) {
            let mut len: usize = 0;
